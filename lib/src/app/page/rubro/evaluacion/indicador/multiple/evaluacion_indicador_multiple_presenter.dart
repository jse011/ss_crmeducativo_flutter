...
class EvaluacionIndicadorMultiplePresenter extends Presenter {
  ...
  EvaluacionIndicadorMultiplePresenter(RubroRepository rubroRepo, ConfiguracionRepository configuracionRepo):_getRubroEvaluacion = GetRubroEvaluacion(rubroRepo, configuracionRepo);
