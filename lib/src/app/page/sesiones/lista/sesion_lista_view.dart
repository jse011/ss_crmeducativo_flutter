...
class _CursoListaViewState extends ViewState<SesionListaView, SesionController> with TickerProviderStateMixin{
  ...
  _CursoListaViewState(cursoUi) : super(SesionController(cursoUi));
...
// Here you can write your code
  ...
  Widget tabSesionDocente(SesionController controller, int countRow) {
    return Padding(
              ...
              delegate: SliverChildListDelegate(
                [
                  Padding(
                    ...
                    child: Text("U2: ESPERANZA EN MEDIO DEL CAOS",
                      style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w800,
                          fontFamily: AppTheme.fontTTNorms
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate(
                    ...
                    return InkWell(
                      onTap: (){
                        AppRouter.createRouteSesionPortalRouter(context, controller.cursosUi);
                      },
                      child: Stack(
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(child: Text("Sesión ${index+1}", style: TextStyle(color: AppTheme.black, fontSize: 12, fontWeight: FontWeight.w600),),),
                                      Text("90 min",  style: TextStyle(color: AppTheme.colorAccent, fontSize: 10,))
                                    ],
                                  ),
                                ),
                                Padding(
                                  padding: EdgeInsets.only(left: 12, right: 16, top: 4, bottom: 0),
                                  child: Text("Mié 26 de May.",  style: TextStyle(color: AppTheme.colorAccent, fontSize: 10,)),
                                ),
                                Padding(
                                  padding: EdgeInsets.only(left: 12, right: 16, top: 4, bottom: 0),
                                  child: Divider(
                                ...
                                Padding(
                                  ...
                                  child: Center(
                                    child: Text("Escribimos frases y oraciones", style: TextStyle(color: AppTheme.black),),
                                  ),
                                )
                              ],
                            ),
